...
@RestController
@RequestMapping("/api/trial-app-kafka")
public class TrialAppKafkaResource {

    private final Logger log = LoggerFactory.getLogger(TrialAppKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public TrialAppKafkaResource(KafkaProperties kafkaProperties) {
